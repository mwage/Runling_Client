...
namespace Client.Scripts.RLR
{
    public class ControlRLR : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                GameControl.GameState.CharacterDto = new CharacterDto(9, "Cat", 0, 0, 0, 0, 1, new []{0,0});
                GameControl.GameState.Solo = true;
            }

            Debug.Log(GameControl.GameState.CharacterDto.Name);
            ...
            PlayerManager = _initializeGame.InitializePlayer(new global::Game.Scripts.Network.Data.Player(0, PlayerPrefs.GetString("username"), PlayerColor.Green));
