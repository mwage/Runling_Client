...
namespace MP.TSGame.Drones.Pattern
{
    public class Pat360Drones : APattern
    {
        ...
        public override void SetPattern(DroneFactory factory, IDrone drone, Area area, StartPositionDelegate posDelegate = null)
        {
            ...
            TrueSyncManager.SyncedStartCoroutine(Generate360Drones(factory, drone, area, posDelegate));
        }

        public override void AddPattern(DroneFactory factory, GameObject drone, IDrone addedDrone, Area area)
        {
            TrueSyncManager.SyncedStartCoroutine(Generate360Drones(factory, addedDrone, area, delegate { return TSVector.zero; }, drone));
        }
        ...
        private IEnumerator Generate360Drones(DroneFactory factory, IDrone drone, Area area, StartPositionDelegate posDelegate, GameObject parentDrone = null)
        {
            ...
            var position = posDelegate((float)drone.Size, area);
            ...
            {
                yield return InitialDelay.Value;
            }
            ...
            do
            {
                do
                {
                    for (var i = 0; i < NumRays; i++)
                    {
                        ...
                        if (parentDrone != null)
                        {
                            position = parentDrone.GetComponent<TSTransform>().position;
                        }
                        ...
                        if (Delay != null)
                            yield return Delay.Value / NumRays;
                    }
                    if (ChangeDirection)
                    {
