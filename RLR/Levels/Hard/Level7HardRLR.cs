...
namespace Assets.Scripts.RLR.Levels
{
    public class Level7HardRLR : ALevelRLR
    {
        ...
        public override void CreateDrones()
        {
            ...
            {
                DroneFactory.SpawnDrones(new RandomDrone(7, 2, Color.grey), (int)(11 - i * 0.4f), area: laneArea[i]);
            }
            ...
            DroneFactory.SetPattern(new PatContinuousSpawn(0.1f, 1),
                new RandomDrone(13, 2, Color.yellow, restrictedZone: 0, droneType: DroneType.FlyingOnewayDrone, moveDelegate: DroneMovement.FixedCosinusoidalMovement, sinForce: 80, sinFrequency: 5.5f));
        }
    }
}
