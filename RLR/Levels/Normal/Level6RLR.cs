...
namespace Assets.Scripts.RLR.Levels
{
    public class Level6RLR : ALevelRLR
    {
        ...
        {
            Manager.RunlingChaser.SetChaserPlatforms(new DefaultDrone(6, 1f, Color.green, moveDelegate: DroneMovement.ChaserMovement, player: Manager.InitializeGameRLR.Player), new int[2] { 1, 8}, new int[2] { 4, 12});
        }
