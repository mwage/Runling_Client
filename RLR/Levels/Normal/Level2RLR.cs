...
namespace Assets.Scripts.RLR.Levels
{
    public class Level2RLR : ALevelRLR
    {
        ...
        {
            Manager.RunlingChaser.SetChaserPlatforms(new DefaultDrone(7, 1f, Color.green, moveDelegate: DroneMovement.ChaserMovement), new int[3] { 1, 8, 16 }, new int[3] { 4, 12, 19 });
        }
