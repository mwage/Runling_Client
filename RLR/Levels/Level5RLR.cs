...
namespace Assets.Scripts.RLR.Levels
{
    public class Level5RLR : ALevelRLR
    {
        ...
        public override void CreateDrones()
        {
            ...
            {
                DroneFactory.SpawnDrones(new RandomDrone(5, 1f, Color.grey), (int) (10 - i * 0.4f), area: laneArea[i]);
                DroneFactory.SpawnDrones(new RandomDrone(5, 2f, Color.grey), (int) (5 - i * 0.2f), area: laneArea[i]);
            }
